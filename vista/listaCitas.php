                    ...
                    <div class="container-fluid">
                      ...
                      <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h6 class="font-weight-bold bio2 mt-2">Lista de citas</h6>
                              <button class="ml-auto btn btn-primary"><i class="fas fa-fw fa-plus"></i> Nueva cita</button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  ...
                                  <tbody>
                                    ...
                                    <td>3</td>
                                    <td>
                                      <form method="post" action="?pagina=citas">
