                    ...
                    <div class="container-fluid">
                      ...
                      <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h6 class="font-weight-bold bio2 mt-2">Lista de pacientes</h6>
                              <button class="ml-auto btn btn-primary"><i class="fas fa-fw fa-plus"></i> Nuevo paciente</button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  ...
                                  <tbody>
                                    ...
                                    <td>Doe</td>
                                    <td>87654321</td>
                                    <td>Urb. Punto Fijo</td>
                                    <td>0251 1234567</td>
                                    <td>0424 7654321</td>
                                    <td>ejemplo@gmail.com</td>
                                    <td>
                                      <form method="post" action="?pagina=paciente">
