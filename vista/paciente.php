                    ...
                    <div class="container-fluid">
                      ...
                      <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h6 class="font-weight-bold bio2 mt-2">Nuevo paciente</h6>
                        </div>
                        <div class="card-body">
                        <div class="p-4">
                            <form class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="cedula" name="cedula" placeholder="Cédula paciente">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <input type="textarea" class="form-control form-control-user" id="direccion" name="direccion" placeholder="Dirección">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="tlfLocal" name="tlfLocal" placeholder="Teléfono local">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="tlfMovil" name="tlfMovil" placeholder="Teléfono móvil">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <button type="submit" href="?pagina=paciente" class="btn btn-primary btn-user btn-block" name="registrar">
                                            Registrar paciente
                                        </button>
                                    </div>
                                </div>
